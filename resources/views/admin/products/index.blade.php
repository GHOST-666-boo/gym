...
@section('header')
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Manage your gym machines catalog</p>
        </div>
    ...
    <div class="p-6">
                                        ...
                                        <div class="flex items-center">
                                            @php
                                                ...
                                                if ($product->relationLoaded('images') && $product->images->count()) {
                                                    ...
                                                    $thumbnailUrl = asset('storage/' . $product->image_path);
                                                }
                                            @endphp
                                            @if($thumbnailUrl)
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">Get started by creating your first gym machine product.</p>
                <div class="mt-6">
                    <a href="{{ route('admin.products.create') }}" 
...
<script>
    function confirmDelete(productSlug, productName) {
        ...
        // Build URL with slug to match admin binding
        document.getElementById('deleteForm').action = `{{ url('/admin/products') }}/${productSlug}`;
