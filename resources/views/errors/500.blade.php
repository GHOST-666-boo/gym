...
@section('title', 'Server Error - Gym Machines')
    ...
    <div class="max-w-md w-full space-y-8 text-center">
        ...
        <div class="mt-8 space-y-4">
            ...
            <div class="text-sm text-gray-500">
                <p>If this problem persists, please <a href="{{ route('contact') }}" class="text-blue-600 hover:text-blue-500 underline">contact us</a>.</p>
            </div>
        </div>
    </div>
</div>
