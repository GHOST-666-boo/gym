...
@section('title', meta_title() ?: site_name() . ' - Professional Fitness Equipment')
@section('description', meta_description() ?: 'Discover our premium collection of gym machines and fitness equipment. Professional grade equipment for commercial and home gyms.')
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
            @foreach($featuredProducts as $product)
                <div class="animate-fade-in-up">
                    <x-product-card :product="$product" :show-button="false" />
                </div>
            @endforeach
        </div>
